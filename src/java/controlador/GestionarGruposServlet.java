/*
El GestionarGruposServlet es un controlador encargado de obtener 
los profesores y cursos de la base de datos para asignarlos como atributos de la sesión
y utilizarlos posteriormente en gestionGrupos.jsp.
 */
package controlador;
...
public class GestionarGruposServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Obtener los cursos y profesores de la base de datos
            List<Curso> cursos = bbdd.obtenerCursos();
            List<Profesor> profesores = bbdd.obtenerProfesores();

            // Establecer los atributos para el JSP:
            request.setAttribute("cursos", cursos);
            request.setAttribute("profesores", profesores);

            // Redirigir a la vista de gestión de grupos:
            request.getRequestDispatcher("/vistas/gestionGrupos.jsp").forward(request, response);
